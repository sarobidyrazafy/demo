...
public class CvController {
    ...
    public ModelAndView insert_cv(
        ...
        @RequestParam("id_sexe") long sexe,
        ...
        try {
            ...
            ArrayList<CvLangue> cvLangues = new ArrayList<>();
            ArrayList<CvDiplome> cvDiplomes = new ArrayList<>();
            ArrayList<CvExperience> cvExperiences = new ArrayList<>();
